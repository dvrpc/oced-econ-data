...
# Region
reg_mar22_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/County/co2203c.txt",
    dtype={
        "State_FIPS": str,
        "County_FIPS": str,
        "units_1unit": float,
...
reg_feb22_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/County/co2202c.txt",
    dtype={
        "State_FIPS": str,
        "County_FIPS": str,
        "units_1unit": float,
...
reg_jan22_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/County/co2201c.txt",
    dtype={
        "State_FIPS": str,
        "County_FIPS": str,
        "units_1unit": float,
...
reg_dec21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/County/co2112c.txt",
    dtype={
        "State_FIPS": str,
        "County_FIPS": str,
        "units_1unit": float,
...
reg_nov21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/County/co2111c.txt",
    dtype={
        "State_FIPS": str,
        "County_FIPS": str,
        "units_1unit": float,
...
reg_oct21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/County/co2110c.txt",
    dtype={
        "State_FIPS": str,
        "County_FIPS": str,
        "units_1unit": float,
...
reg_sep21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/County/co2109c.txt",
    dtype={
        "State_FIPS": str,
        "County_FIPS": str,
        "units_1unit": float,
...
reg_aug21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/County/co2108c.txt",
    dtype={
        "State_FIPS": str,
        "County_FIPS": str,
        "units_1unit": float,
...
reg_jul21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/County/co2107c.txt",
    dtype={
        "State_FIPS": str,
        "County_FIPS": str,
        "units_1unit": float,
...
reg_jun21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/County/co2106c.txt",
    dtype={
        "State_FIPS": str,
        "County_FIPS": str,
        "units_1unit": float,
...
reg_may22_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/County/co2105c.txt",
    dtype={
        "State_FIPS": str,
        "County_FIPS": str,
        "units_1unit": float,
...
reg_apr22_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/County/co2104c.txt",
    dtype={
        "State_FIPS": str,
        "County_FIPS": str,
        "units_1unit": float,
...
reg_mar21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/County/co2103c.txt",
    dtype={
        "State_FIPS": str,
        "County_FIPS": str,
        "units_1unit": float,
...
reg_feb21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/County/co2102c.txt",
    dtype={
        "State_FIPS": str,
        "County_FIPS": str,
        "units_1unit": float,
...
reg_jan21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/County/co2101c.txt",
    dtype={
        "State_FIPS": str,
        "County_FIPS": str,
        "units_1unit": float,
...
msa_mar22_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/Metro/ma2203c.txt",
    dtype={
        "FIPS": str,
        "units_1unit": float,
        "units_2units": float,
    ...
    names=msa_header_list,
    low_memory=False,
    skiprows=[0, 1],
)
msa_feb22_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/Metro/ma2202c.txt",
    dtype={
        "FIPS": str,
        "units_1unit": float,
        "units_2units": float,
...
msa_jan22_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/Metro/ma2201c.txt",
    dtype={
        "FIPS": str,
        "units_1unit": float,
        "units_2units": float,
...
msa_dec21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/Metro/ma2112c.txt",
    dtype={
        "FIPS": str,
        "units_1unit": float,
        "units_2units": float,
...
msa_nov21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/Metro/ma2111c.txt",
    dtype={
        "FIPS": str,
        "units_1unit": float,
        "units_2units": float,
...
msa_oct21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/Metro/ma2110c.txt",
    dtype={
        "FIPS": str,
        "units_1unit": float,
        "units_2units": float,
...
msa_sep21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/Metro/ma2109c.txt",
    dtype={
        "FIPS": str,
        "units_1unit": float,
        "units_2units": float,
...
msa_aug21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/Metro/ma2108c.txt",
    dtype={
        "FIPS": str,
        "units_1unit": float,
        "units_2units": float,
...
msa_jul21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/Metro/ma2107c.txt",
    dtype={
        "FIPS": str,
        "units_1unit": float,
        "units_2units": float,
...
msa_jun21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/Metro/ma2106c.txt",
    dtype={
        "FIPS": str,
        "units_1unit": float,
        "units_2units": float,
...
msa_may22_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/Metro/ma2105c.txt",
    dtype={
        "FIPS": str,
        "units_1unit": float,
        "units_2units": float,
...
msa_apr22_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/Metro/ma2104c.txt",
    dtype={
        "FIPS": str,
        "units_1unit": float,
        "units_2units": float,
...
msa_mar21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/Metro/ma2103c.txt",
    dtype={
        "FIPS": str,
        "units_1unit": float,
        "units_2units": float,
...
msa_feb21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/Metro/ma2102c.txt",
    dtype={
        "FIPS": str,
        "units_1unit": float,
        "units_2units": float,
...
msa_jan21_month = pd.read_csv(
    r"https://www2.census.gov/econ/bps/Metro/ma2101c.txt",
    dtype={
        "FIPS": str,
        "units_1unit": float,
        "units_2units": float,
